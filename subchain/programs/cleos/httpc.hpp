...
namespace eosio { namespace client { namespace http {
   ...
   //const string reg_subchain_func = chain_func_base + "/reg_subchain"; //wangchao
   //const string get_subchain_info_func = chain_func_base + "/register_subchain"; //wangchao
   const string get_subchain_info_func = chain_func_base + "/get_subchain_info"; //wangchao
   const string reg_suchain_func = chain_func_base + "/reg_subchain";  //wangchao
   ...
   const string get_subchain_block_func = chain_func_base + "/get_subchain_block";
