...
void chain_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
      ...
      //CHAIN_RO_CALL(reg_subchain, 200),
      CHAIN_RO_CALL(get_subchain_info, 200), //subchain info -wangchao-2018.8.23
      CHAIN_RO_CALL(get_subchain_block, 200), //subchain block -wangchao-2018.8.23
