...
public:
   ...
   using get_subchain_info_params = empty; //wangchao
   ...
   get_info_results get_subchain_info(const get_subchain_info_params&) const; //wangchao
  
   //wangchao add for register subchain. 2018.9.18
   struct get_reg_results {
		 string 				 server_version;
		 chain::chain_id_type	 chain_id;
		 uint32_t				 head_block_num = 0;
		 uint32_t				 last_irreversible_block_num = 0;
   ...
   struct reg_subchain_params {
      name account_name;
      bool code_as_wasm = false;
   };

   get_reg_results reg_subchain(const reg_subchain_params&) const; //wangchao
   ...
   struct get_subchain_block_params {
      string block_num_or_id;
      uint32_t block_num = 1;
   };

   fc::variant get_block(const get_block_params& params) const;
   fc::variant get_subchain_block(const get_subchain_block_params& params) const; //wangchao
...
FC_REFLECT(eosio::chain_apis::read_only::get_reg_results,
(server_version)(chain_id)(head_block_num)(last_irreversible_block_num)(last_irreversible_block_id)(head_block_id)(head_block_time)(head_block_producer) )
FC_REFLECT(eosio::chain_apis::read_only::get_block_params, (block_num_or_id)(block_num))
FC_REFLECT(eosio::chain_apis::read_only::get_subchain_block_params, (block_num_or_id)(block_num))
