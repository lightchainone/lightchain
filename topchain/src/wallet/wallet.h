...
extern CWalletRef bridgeownerpwallet;
...
static const bool DEFAULT_DISABLE_OWNER = true;
...
public:
    ...
    static bool InitLoadOwnerWallet();
...
public:
    ...
    std::string toString(){
       return strprintf("nIndex=%d fInternal=%d",nIndex,fInternal);
    }
