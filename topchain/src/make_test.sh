g++ -std=c++11 -DHAVE_CONFIG_H \
              ...
              -pthread -Wl,-z -Wl,relro -Wl,-z -Wl,now -pie -o testapi  libbitcoin_cliapi.a   univalue/.libs/libunivalue.a  -L/usr/lib64 -lboost_system -lboost_filesystem -lboost_program_options-mt -lboost_thread -lboost_chrono-mt -lssl -lcrypto -levent -pthread  -lgmp
