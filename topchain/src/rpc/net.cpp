...
UniValue gettopnode(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            "gettopnode\n"
            "\nReturns data about topnode's 1-3 connected network node as a json array of objects.\n"
            "\nResult:\n"
            "[\n"
            "  {\n"
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("gettopnode", "")
            + HelpExampleRpc("gettopnode", "")
        );
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "network",            "gettopnode",             &gettopnode,             true,  {} },
