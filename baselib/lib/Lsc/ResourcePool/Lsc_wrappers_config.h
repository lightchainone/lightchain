...
#define  __BSL_WRAPPERS_CONFIG_H_
    ...
    #warning type-traits support not implemented for the current g++ version. Default implementation is used. Add related configuration to Lsc_wrappers_config.h to add type-traits support. Disable this wanring by defining marco BSL_CONFIG_NO_TYPE_TRAITS_WARNIBSL.
    #endif  //BSL_CONFIG_NO_TYPE_TRAITS_WARNIBSL

    namespace Lsc{
        typedef struct __Lsc_true_type__{}     __Lsc_true_type__;
        typedef struct __Lsc_false_type__{}    __Lsc_false_type__;
    }

    #define __BSL_TRUE_TYPE__   __Lsc_true_type__
    #define __BSL_FALSE_TYPE__  __Lsc_false_type__
