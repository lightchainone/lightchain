    ...
    template<typename implement_t>
        ...
        plclic:
            ...
            **/
             ...
             * 
            **/
            virtual BasicArray& clone( Lsc::ResourcePool& rp) const {
             ...
             * 
            **/
            virtual BasicArray& clone( Lsc::ResourcePool& rp, bool is_deep_copy ) const {
            ...
            virtual string_type dump(size_t verbose_level = 0) const {
                ...
                if ( verbose_level == 0 ){
                    res.appendf(
                            "[Lsc::var::BasicArray] this[%p] size[%zd]", 
                            this, _array.size() 
                            ); 
                }else{
