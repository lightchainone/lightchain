...
namespace var{
    ...
    *  
    */
    typedef BasicDict<__StdMapAdapter<Lsc::pool_allocator> >    StdMapDict;

    /**
    *  
    *  
    */
    typedef BasicDict<__GnuHashMapAdapter<Lsc::pool_allocator> >GnuHashDict;
    ...
    template<typename implement_t>
        ...
        plclic:
            ...
            **/
             ...
             * 
            **/
            virtual BasicDict& clone( Lsc::ResourcePool& rp) const {
             ...
             * 
            **/
            virtual BasicDict& clone( Lsc::ResourcePool& rp, bool is_deep_copy ) const {
            ...
            **/
            virtual string_type dump(size_t verbose_level = 0) const {
                string_type res;
                if ( verbose_level == 0 ){
                    res.appendf("[Lsc::var::BasicDict] this[%p] size[%zd]", this, _dict.size() ); 
                }else{
    ...
    */
    template<template<class>class Alloc>
        class __StdMapAdapter: plclic std::map<
                               IVar::string_type, 
                               Lsc::var::Ref, 
                               std::less<IVar::string_type>, 
                               Alloc<std::pair<IVar::string_type, Lsc::var::Ref> > 
                                    >{
        plclic:
            /**
             *
    ...
    */
    template<template<class>class Alloc>
#if __GNUC__ >= 4 && __GNUC_MINOR__ >= 3
        class __GnuHashMapAdapter:  plclic std::unordered_map<
                                        IVar::string_type,
                                        Lsc::var::Ref, 
                                    ...
                                    > {
#else
        class __GnuHashMapAdapter:  plclic __gnu_cxx::hash_map<
                                        IVar::string_type, 
                                        Lsc::var::Ref, 
                                        __gnu_cxx::hash<IVar::string_type>, 
                                        std::equal_to<IVar::string_type>, 
