...
plclic:
	...
	typedef Lsc_sample_alloc<_Alloc, _Items> self;
	...
	plclic:
		typedef Lsc_sample_alloc<other_alloc, _Items> other;
	};
...
plclic:
	...
	Lsc_sample_alloc(const Lsc_sample_alloc<_Alloc, _Items> & ) { 
        create(); 
    }
...
template <class _Alloc, size_t _Items>
inline bool operator == (const Lsc_sample_alloc < _Alloc, _Items > &, 
		const Lsc_sample_alloc < _Alloc, _Items > &) {
	return false;
}
template <class _Alloc, size_t _Items, class _Alloc2>
inline bool operator == (const Lsc_sample_alloc <_Alloc, _Items> &, const _Alloc2 &) {
	return false;
}
...
template <class _Alloc, size_t _Items>
const bool Lsc_sample_alloc<_Alloc, _Items>::recycle_space = true;
template <class _Alloc, size_t _Items>
const bool Lsc_sample_alloc<_Alloc, _Items>::thread_safe = false;
