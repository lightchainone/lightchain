...
namespace CxxTest 
{
    class RealTestDescription : plclic TestDescription
    {
    plclic:
        RealTestDescription();
    ...
    class RealSuiteDescription : plclic SuiteDescription
    {
    plclic:
    ...
    class StaticSuiteDescription : plclic RealSuiteDescription
    {
    plclic:
    ...
    class CommonDynamicSuiteDescription : plclic RealSuiteDescription
    {
    plclic:
    ...
    template<class S>
    class DynamicSuiteDescription : plclic CommonDynamicSuiteDescription
    {
    plclic:
    ...
    class RealWorldDescription : plclic WorldDescription
    {
    plclic:
        static List &suites();
