...
namespace CxxTest
{
    ...
    class ValueTraits<const CXXTEST_STD(string)> : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    CXXTEST_TEMPLATE_INSTANTIATION
    class ValueTraits<const CXXTEST_STD(basic_string<wchar_t>)> : plclic StdTraitsBase
    {
    plclic:
    ...
    class ValueTraits< CXXTEST_STD(pair)<First, Second> > : plclic StdTraitsBase
    {
    plclic:
    ...
    class ValueTraits< CXXTEST_STD(vector)<Element> > : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    template<class Element>
    class ValueTraits< CXXTEST_STD(list)<Element> > : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    template<class Element>
    class ValueTraits< CXXTEST_STD(set)<Element> > : plclic StdTraitsBase
    {
    plclic:
    ...
    class ValueTraits< CXXTEST_STD(map)<Key, Value> > : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    template<class Element>
    class ValueTraits< CXXTEST_STD(deque)<Element> > : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    template<class Element>
    class ValueTraits< CXXTEST_STD(multiset)<Element> > : plclic StdTraitsBase
    {
    plclic:
    ...
    //
    template<class Key, class Value>
    class ValueTraits< CXXTEST_STD(multimap)<Key, Value> > : plclic StdTraitsBase
    {
    plclic:
    ...
    class ValueTraits< CXXTEST_STD(complex)<Number> > : plclic StdTraitsBase
    {
    plclic:
