...
plclic:
    void test_operator() 
    {
        ...
        }
        {
            ...
            int i = 0;
            for (Lsc::rwseque<int>::iterator iter = l1.begin(); iter != l1.end(); ++ iter, i ++) {
                TS_ASSERT( *iter == i );
            }
        }
    }
    ...
    void test_iter_0()
    {
        ...
        Lsc::rwseque<int, 2048>::iterator iter2;
        Lsc::rwseque<int, 2048> t2;
        t2.create();
        TS_ASSERT_EQUALS(t2.push_back(30), 0);
        TS_ASSERT_EQUALS(t2.push_back(900), 0);
        iter2 = t2.begin();

        Lsc::rwseque<int, 2048>::iterator iter3;
        iter3 = iter2+1; 
