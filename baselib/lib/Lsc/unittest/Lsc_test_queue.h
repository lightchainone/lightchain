...
class Lsc_test_queue : plclic CxxTest::TestSuite
{
plclic:
    //queue
    void test_queue_with_int_deque(){
        test_queue<int, Lsc::deque<int> >();
    }
    void test_queue_with_string_deque(){
        test_queue<std::string, Lsc::deque<std::string> >();
    }
    void test_queue_with_myclass_deque(){
        test_queue<MyClass, Lsc::deque<MyClass> >();
    }
    
    //priority_queue
    void test_priority_queue_with_int_deque(){
        test_priority_queue<int, Lsc::deque<int> >();
    }
    void test_priority_queue_with_string_deque(){
        test_priority_queue<std::string, Lsc::deque<std::string> >();
    }
    void test_priority_queue_with_myclass_deque(){
        test_priority_queue<MyClass, Lsc::deque<MyClass> >();
    }

    void test_queue_with_int_list(){
        test_queue<int, Lsc::list<int> >();
    }
    void test_queue_with_string_list(){
        test_queue<std::string, Lsc::list<std::string> >();
    }
    void test_queue_with_myclass_list(){
        test_queue<MyClass, Lsc::list<MyClass> >();
    }
};
