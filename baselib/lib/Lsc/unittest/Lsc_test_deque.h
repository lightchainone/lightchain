...
class Lsc_test_deque : plclic CxxTest::TestSuite
{
plclic:
    void test_operator() 
    {
        {
            ...
            int i = 0;
            for (Lsc::deque<int>::iterator Iter = t2.begin(); Iter != t2.end(); ++ Iter) {
                TS_ASSERT( *Iter == i ++ );
            }
            i = 0;
            t1 = t1;
            TS_ASSERT( 100 == t1.size() );
            for (Lsc::deque<int>::iterator Iter = t1.begin(); Iter != t1.end(); ++ Iter) {
                TS_ASSERT( *Iter == i ++ );
            }
            Lsc::deque<int> t3;
            t3.push_back(1);
        ...
        {
            Lsc::deque<Lsc::string> l1;
            Lsc::deque<Lsc::string> l2;
        ...
        }
        {
            ...
            TS_ASSERT( 100 == l1.size() );
            int i = 0;
            for (Lsc::deque<int>::iterator iter = l2.begin(); iter != l2.end(); ++ iter, i ++) {
                TS_ASSERT( *iter == i );
            }
        }
    }
	...
	void test_push_front_0()
	{
        ...
        int v = n - 1;
        for (Lsc::deque<int>::iterator iter = t0.begin();
                iter != t0.end();
                ++iter) {
           TS_ASSERT(*iter == v);
            --v;
        ...
        for (Lsc::deque<int>::const_iterator iter = t0.begin();
                iter != t0.end();
                ++iter) {
            TS_ASSERT(*iter == v);
            --v;
        ...
        for (Lsc::deque<int>::reverse_iterator iter = t0.rbegin();
                iter != t0.rend();
                ++iter) {
            TS_ASSERT(*iter == v);
            ++v;
        ...
        for (Lsc::deque<int>::const_reverse_iterator iter = t0.rbegin();
                iter != t0.rend();
                ++iter) {
            TS_ASSERT(*iter == v);
            v++;
    ...
    void test_push_front_1()
    {
        ...
        for (Lsc::deque<std::string>::iterator iter = t1.begin();
                iter != t1.end();
                ++iter, ++dt_iter) {
        ...
        for (Lsc::deque<std::string>::const_iterator iter = t1.begin();
                iter != t1.end();
                ++iter, ++dt_iter1) {
    ...
    void test_push_front_2()
    {
        ...
        for (Lsc::deque<MyClass>::iterator iter = t1.begin();
                iter != t1.end();
                ++iter, ++dt_iter) {
            TS_ASSERT(*iter == *dt_iter);
        }
        ...
        for (Lsc::deque<MyClass>::const_iterator iter = t1.begin();
                iter != t1.end();
                ++iter, ++dt_iter1) {
            TS_ASSERT(*iter == *dt_iter1);
        }
    ...
    void test_iter_0()
    {
        ...
        Lsc::deque<int, 2048>::iterator iter2;
        Lsc::deque<int, 2048> t2;
        t2.create();
        TS_ASSERT_EQUALS(t2.push_back(30), 0);
        TS_ASSERT_EQUALS(t2.push_back(900), 0);
        iter2 = t2.begin();

        Lsc::deque<int, 2048>::iterator iter3;
        iter3 = iter2+1; 
        ...
        Lsc::deque<int, 2048>::const_iterator iter4;
        iter4 = t2.begin();
