...
class Lsc_test_stack : plclic CxxTest::TestSuite
{
plclic:
    void test_stack_with_int_deque(){
        test_stack<int, Lsc::deque<int> >();
    }
    void test_stack_with_string_deque(){
        test_stack<std::string, Lsc::deque<std::string> >();
    }
    void test_stack_with_myclass_deque(){
        test_stack<MyClass, Lsc::deque<MyClass> >();
    }
    void test_stack_with_int_list(){
        test_stack<int, Lsc::list<int> >();
    }
    void test_stack_with_string_list(){
        test_stack<std::string, Lsc::list<std::string> >();
    }
    void test_stack_with_myclass_list(){
        test_stack<MyClass, Lsc::list<MyClass> >();
    }
};
