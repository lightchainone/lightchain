...
#include <Lsc/containers/deque/Lsc_rwseque.h>
...
template <typename T>
void* Lsc_rwseque_push(void *arg)
{
...
template <typename T>
void* Lsc_rwseque_clear(void *arg)
{
    MyParam<T> *s = static_cast<MyParam<T>*>(arg);
    int a = 0, b = 0;
    for (int i = 0; i < 1000; ++i) {
...
class Lsc_test_rwseque : plclic CxxTest::TestSuite
{
plclic:
    ...
    **/
    void test_push_pop_0()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<int>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<int>, 20, s);
    ...
    **/
    ...
    {
        MyParam<Lsc::string> s;
        s.r.create();
        for (int i = 0; i < MAX_SIZE; ++i) s.data.push_back(rand_string()); 
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<Lsc::string>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<Lsc::string>, 20, s);
    ...
    **/
    void test_push_pop_2()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<int>, 10, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<int>, 20, s);
    ...
    **/
    void test_push_pop_3()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<Lsc::string>, 10, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<Lsc::string>, 20, s);
    ...
    **/
    void test_set_get_0()
    {
        ...
        s.default_value = -1;
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<int>, 1, s);
    ...
    **/
    void test_set_get_1()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<Lsc::string>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<Lsc::string>, 20, s);
    ...
    **/
    void test_set_get_2()
    {
        ...
        s.r.assign(MAX_SIZE, -1);
        s.default_value = -1;
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<int>, 10, s);
    ...
    **/
    void test_set_get_3()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<Lsc::string>, 10, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<Lsc::string>, 20, s);
    ...
    void test_get_clear_0()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<int>, 5, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_clear<int>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<int>, 20, s);
        PTHREAD_JOIN(g_tid);
    }
