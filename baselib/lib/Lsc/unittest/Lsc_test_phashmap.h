...
{
plclic:
	typedef Lsc::phashmap<std::string, std::string, hash_key> type1_t;
	...
	typedef Lsc::phashmap<std::string, std::string, hash_key, Lsc::equal<std::string>,
			Lsc::Lsc_alloc<std::string> > type2_t;
	...
	///
	typedef Lsc::phashmap<std::string, std::string, hash_key, Lsc::equal<std::string>,
			Lsc::Lsc_cpsalloc<Lsc::Lsc_alloc<std::string> > > type3_t;
	...
	void test_get_callback(){	
		typedef int _Key;
		typedef int _Value;
		typedef Lsc::phashmap<_Key, _Value> hash_type;
