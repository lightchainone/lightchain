...
plclic:
    ...
    **/
    void test_push_pop_1()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<std::string>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<std::string>, 20, s);
    ...
    **/
    void test_push_pop_3()
    {
        ...
        CREATE_PTHREAD(g_tid, Lsc_rwseque_push<std::string>, 10, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<std::string>, 20, s);
    ...
    **/
    void test_set_get_1()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<std::string>, 1, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<std::string>, 20, s);
    ...
    **/
    void test_set_get_3()
    {
        ...
        s.r.assign(MAX_SIZE, "");
        s.default_value = "";
        CREATE_PTHREAD(g_tid, Lsc_rwseque_set<std::string>, 10, s);
        CREATE_PTHREAD(g_tid, Lsc_rwseque_get<std::string>, 20, s);
