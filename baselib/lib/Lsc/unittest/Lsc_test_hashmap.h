...
plclic:
	...
	typedef Lsc::hashmap<std::string, std::string, hash_key> THMp1;
	void test_operator() {
		{
			THMp1 ht;
	...
	**/
	...
	//Lsc_alloc分配器
	typedef Lsc::hashmap<std::string, std::string, hash_key, Lsc::equal<std::string>, Lsc::Lsc_alloc<std::string> > THMp2;
	void test_hashmap2_() {
	...
	//默认的phashmap
	typedef Lsc::phashmap<std::string, std::string, hash_key> THMp3;
	void test_phashmap_() {
	...
	//Lsc_alloc的phashmap
	typedef Lsc::phashmap<std::string, std::string, hash_key, Lsc::equal<std::string>, Lsc::Lsc_alloc<std::string> > THMp4;
	...
	//Lsc_cpsalloc分配器
	typedef Lsc::phashmap<std::string, std::string, hash_key, Lsc::equal<std::string>, Lsc::Lsc_cpsalloc<Lsc::Lsc_alloc<std::string> > > THMp5;
	...
	void test_phashmap3_clear_() {
		Lsc::hashmap<int, std::string> v1;
		Lsc::hashmap<int, Lsc::string> v2;
		v1.create(100);
		v2.create(1000);
		v1.set(1, "hello");
		v1.get(1);
