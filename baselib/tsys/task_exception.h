#ifndef  __TASK_EXCEPTION_H_
#define  __TASK_EXCEPTION_H_
...
#define THROW_REDIS_TABLE_NAME_FORMAT(fmt...) THROW(lnsys::LNSYS_E_REDIS_TABLE_NAME_FORMAT, ##fmt)
#define THROW_VALUE_FORMAT(fmt...) THROW(lnsys::LNSYS_VALUE_FORMAT, ##fmt)
#define THROW_KEY_FORMAT(fmt...) THROW(lnsys::LNSYS_KEY_FORMAT, ##fmt)
