...
#ifndef PLCLIC_MCPACK_SAMPLE_MCPACKARRAYSHORTINT32_H_
#define PLCLIC_MCPACK_SAMPLE_MCPACKARRAYSHORTINT32_H_

#include "McpackGenerator.h"
class McpackArrayShortInt32:plclic McpackGenerator{
    plclic:
    ...
    mc_pack_t *Generate(){
        ...
        for(int i=0;i<1000;i++){
            assert(!mc_pack_put_int32(arraypack,NULL,12));
        }
